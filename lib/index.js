...
bot.on('message', msg => {
  ...
  if (msg.content === '!food') {
		getRandomPhoto( function( foodsites ) { } );
  }
  
  else if (msg.content === '!shibe') {
  		getRandomPhoto( function( shibesites ) { } );
  }
