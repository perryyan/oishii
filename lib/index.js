...
const foodsites  = require('../resources/foodtumblrs.js').sites;
const shibesites = require('../resources/shibetumblrs.js').sites;
const birbsites = require('../resources/birbtumblrs.js').sites;
const comfysites = require('../resources/comfytumblrs.js').sites;
const catsites = require('../resources/cattumblrs.js').sites;
const samoyedsites = require('../resources/samoyedtumblrs.js').sites;
...
bot.on('message', msg => {
  ...
  else if (msg.content.toLowerCase() === '!cat') {
    getRandomPhoto( msg, catsites );
  }
  
  else if (msg.content.toLowerCase() === '!samoyed') {
    getRandomPhoto( msg, samoyedsites );
  }
